# 事件时间轴 App · Muted Direction Copy v42 视觉规范
> 日期：2026-04-29  
> 范围：基于 v41 的关注方向文本层级调整，不修改 Flutter 代码  
> 关键调整：弱化关注方向说明，让最新节点消息成为卡片里的第一阅读目标

## 本版调整

v42 只调整“我的关注”专题卡片中的关注方向文字：
...
- `event-timeline-muted-direction-copy.html`
