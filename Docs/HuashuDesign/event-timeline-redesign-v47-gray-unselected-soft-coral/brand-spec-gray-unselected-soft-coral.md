# 事件时间轴 App · Gray Unselected Soft Coral v47 视觉规范
> 日期：2026-04-30  
> 范围：基于 v46 的底部时间轴 Tab 图标配色微调，不修改 Flutter 代码  
> 关键调整：未选中态改为灰色体系，选中态指针线条降低饱和度
...
- `event-timeline-gray-unselected-soft-coral.html`
