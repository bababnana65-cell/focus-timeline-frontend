...
主方向：**Fresh Ribbon / 轻快时间丝带**

- 气质关键词：极简、轻盈、明亮、年轻、可扫读。
- 页面背景使用奶油白和微冷浅灰，不做深色科技感。
- 用浅蓝、薄荷绿、珊瑚橙、淡黄色分担状态语义，避免单一蓝色统治界面。
...
- 有新动态：专题卡片内使用珊瑚红点 + 最新摘要浅黄高亮；底部“我的关注”Tab 显示红点。
...
- 高保真设计板：`event-timeline-mobile-redesign.html`
