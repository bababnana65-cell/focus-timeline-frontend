# 事件时间轴 App · Start Node Rail Trim v56 视觉规范
> 日期：2026-04-30  
> 范围：基于 v55 的时间轴初始节点标记与轨道起点优化，不修改 Flutter 代码  
> 关键调整：重新设计第一个节点旁边的起点图标，并避免绿色轨道线从图标上方冒出
...
- `event-timeline-start-node-rail-trim.html`
