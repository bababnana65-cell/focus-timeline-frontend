# 事件时间轴 App · Muted Recommend Direction Copy v43 视觉规范
> 日期：2026-04-29  
> 范围：基于 v42 的推荐页关注方向文本层级调整，不修改 Flutter 代码  
> 关键调整：推荐页和关注页的关注方向说明使用同一弱化视觉层级

## 本版调整

v43 只调整推荐页专题卡片中的关注方向文字：
...
- `event-timeline-muted-recommend-direction-copy.html`
