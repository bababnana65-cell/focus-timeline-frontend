# 事件时间轴 App · Stable Timeline Text Lane v41 视觉规范
> 日期：2026-04-29  
> 范围：基于 v40 的时间轴节点标题阅读列调整，不修改 Flutter 代码  
> 关键调整：把时间轴标题/摘要改成固定阅读列，避免不同节点看起来右边距不一致
...
- `event-timeline-stable-timeline-text-lane.html`
